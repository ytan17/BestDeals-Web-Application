...
public class AccessoryList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/* Checks the SmartPhone maker whether it is microsft or sony or nintendo 
		   Add the respective product value to hashmap  */

		String CategoryName = request.getParameter("maker");
		String SmartPhoneName = request.getParameter("phone");
		...
		SmartPhone phone = hm.get(SmartPhoneName);
		...
		pw.print("<a style='font-size: 24px;'>"+ phone.getName() +": Accessories</a>");
	    ...
	    Accessory accessory= SaxParserDataStore.accessories.get(acc.getValue());
			...
			pw.print("<li><form method='post' action='Cart'>" +
					...
					"<input type='hidden' name='access' value='"+SmartPhoneName+"'>"+
